    ...
    inputtext: {
      root: ({ props, context }) => ({
        className: classNames(
          "m-0",
          "font-sans text-gray-600 dark:text-white/80 bg-white dark:bg-gray-600 border border-gray-300 dark:border-blue-900/40 transition-colors duration-200 appearance-none rounded-lg",
          {
    ...
    panel: {
      header: ({ props }: { props: any }) => ({
        className: classNames(
          ...
          "dark:bg-gray-600 dark:border-blue-900/40 dark:text-white/80", // Dark mode
      ...
      content: {
        className: classNames(
          ...
          "dark:bg-gray-300 dark:border-blue-900/40 dark:text-white/80" // Dark mode
        ),
      },
    },
  };
